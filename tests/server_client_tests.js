...
if (Meteor.isClient) {
  ...
  Tinytest.addAsync("status - idle report to server", function (test, next) {
    ...
    return Meteor.call("user-status-idle", now, function (err, res) {
      test.isUndefined(err);
  ...
  Tinytest.addAsync("status - active report to server", function (test, next) {
    ...
    return Meteor.call("user-status-active", now, function (err, res) {
      test.isUndefined(err);
  ...
  Tinytest.addAsync("status - idle report with no timestamp", function (test, next) {
    ...
    return Meteor.call("user-status-idle", undefined, function (err, res) {
      test.isUndefined(err);
  ...
  Tinytest.addAsync("status - active report with no timestamp", (test, next) => Meteor.call("user-status-active", undefined, function (err, res) {
    test.isUndefined(err);
