...
const monitorDep = new Deps.Dependency;
const idleDep = new Deps.Dependency;
const activityDep = new Deps.Dependency;
...
var monitor = function (setAction) {
  ...
  const currentTime = Deps.nonreactive(() => TimeSync.serverTime());
